...
KEYS = [
    ...
    ("Esc", 0, 0, 0.7, 1), ("1<br>!", 1, 0, 1.7, 1), ("2<br>@", 2, 0, 2.8, 1),
    ("3<br>#", 3, 0, 3.9, 1), ("4<br>$", 4, 0, 4.9, 1), ("5<br>%", 5, 0, 6.0, 1),
    ("6<br>^", 6, 0, 7.1, 1), ("7<br>&", 7, 0, 8.2, 1), ("8<br>*", 8, 0, 9.2, 1),
    ("9<br>(", 9, 0, 10.3, 1), ("0<br>)", 10, 0, 11.4, 1), ("-<br>_", 11, 0, 12.4, 1),
    ("=<br>+", 12, 0, 13.5, 1), ("Bksp", 13, 0, 14.5, 1.7),
    ("Ins", 14, 0, 16.4, 1),
    ...
    ("P", 25, 1, 11.7, 1), ("[<br>{", 26, 1, 12.8, 1), ("]<br>}", 27, 1, 13.8, 1),
    ("\\<br>|", 28, 1, 14.9, 1.4),
    ("Del", 29, 1, 16.4, 1),
    ...
    ("M", 51, 3, 9.1, 1), (",<br><", 52, 3, 10.2, 1), (".<br>>", 53, 3, 11.2, 1),
    ("/<br>?", 54, 3, 12.3, 1), ("Shift", 55, 3, 13.4, 1.8),
    ("↑", 56, 3, 15.3, 1),
    ("PgDn", 57, 3, 16.4, 1),
